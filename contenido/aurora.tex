...
\begin{itemize}
	\item \emph{PRINCE2 Foundation}: suficiente conocimiento y comprensión del método PRINCE2 para ser capaz de trabajar en un equipo de gestión de proyectos que usa este método. Precio: \EUR{455}.
	\begin{itemize}
		\item Requisitos previos: ninguno
	\end{itemize}
	\item \emph{PRINCE2 Practitioner}: suficiente comprensión de cómo aplicar PRINCE2 en una situación escenario. El acreditado, con la dirección adecuada, será capaz de iniciar la aplicación del método a un proyecto real. Precio: \EUR{455}.
	\begin{itemize}
